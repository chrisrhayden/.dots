...
function SourceryColor()
  ...
  highlight("Cursor", { bg = colors.grey_5, fg = colors.grey_2, sy = "nocombine,bold" })
  ...
  highlight("PmenuSel", { bg = colors.grey_5, fg = colors.grey_1, sy = "nocombine,bold", })
  ...
  highlight("DiagnosticDefaultError", { fg = colors.red_1 })
  ...
  highlight("LspSagaRenamePromptPrefix", { bg = colors.grey_1, fg = colors.purple_3 })
  -- }}}
  ...
  -- wilder {{{
  highlight("FloatBorder", { bg = colors.grey_1, fg = colors.grey_4, sy = "nocombine,NONE" })
  -- }}}
