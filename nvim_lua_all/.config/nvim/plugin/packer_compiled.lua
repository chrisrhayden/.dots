...
_G.packer_plugins = {
  ["i3-vim-syntax"] = {
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/i3-vim-syntax"
  },
  ...
  ["vim-gitgutter"] = {
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/vim-gitgutter"
  },
  ["vim-glsl"] = {
    loaded = true,
  ...
  ["wilder.nvim"] = {
    config = { "\27LJ\1\2�\4\0\0\4\0\a\0\r%\0\0\0%\1\1\0%\2\2\0$\0\2\0004\1\3\0007\1\4\0017\1\5\1%\2\6\0\16\3\0\0$\2\3\2)\3\1\0>\1\3\1G\0\1\0�\2          call wilder#enable_cmdline_enter()\n          set wildcharm=<Tab>\n          cmap <expr> <Tab> wilder#in_context() ? wilder#next() : '\\\\<Tab>'\n          cmap <expr> <S-Tab> wilder#in_context() ? wilder#previous() : '\\\\<S-Tab>'\n          \" only / and ? are enabled by default\n          call wilder#set_option('modes', ['/', '?', ':'])\n        \14nvim_exec\bapi\bvim('/': wilder#wildmenu_renderer(),}))&':': wilder#popupmenu_renderer(),=call wilder#set_option('renderer', wilder#renderer_mux({\0" },
    loaded = true,
...
try_loadstring("\27LJ\1\2�\4\0\0\4\0\a\0\r%\0\0\0%\1\1\0%\2\2\0$\0\2\0004\1\3\0007\1\4\0017\1\5\1%\2\6\0\16\3\0\0$\2\3\2)\3\1\0>\1\3\1G\0\1\0�\2          call wilder#enable_cmdline_enter()\n          set wildcharm=<Tab>\n          cmap <expr> <Tab> wilder#in_context() ? wilder#next() : '\\\\<Tab>'\n          cmap <expr> <S-Tab> wilder#in_context() ? wilder#previous() : '\\\\<S-Tab>'\n          \" only / and ? are enabled by default\n          call wilder#set_option('modes', ['/', '?', ':'])\n        \14nvim_exec\bapi\bvim('/': wilder#wildmenu_renderer(),}))&':': wilder#popupmenu_renderer(),=call wilder#set_option('renderer', wilder#renderer_mux({\0", "config", "wilder.nvim")
